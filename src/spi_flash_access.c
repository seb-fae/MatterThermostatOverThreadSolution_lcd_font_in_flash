...
void spi_init(void)
{
  // Init flash
   ...
   // IO config
   sl_gpio_set_pin_mode(&(sl_gpio_t) {SL_USART_EXTFLASH_TX_PORT, SL_USART_EXTFLASH_TX_PIN }, SL_GPIO_MODE_PUSH_PULL, 1);
   sl_gpio_set_pin_mode(&(sl_gpio_t) {SL_USART_EXTFLASH_RX_PORT, SL_USART_EXTFLASH_RX_PIN }, SL_GPIO_MODE_INPUT, 0);
   sl_gpio_set_pin_mode(&(sl_gpio_t) {SL_USART_EXTFLASH_CLK_PORT, SL_USART_EXTFLASH_CLK_PIN }, SL_GPIO_MODE_PUSH_PULL, 1);
   sl_gpio_set_pin_mode(&(sl_gpio_t) {SL_USART_EXTFLASH_CS_PORT, SL_USART_EXTFLASH_CS_PIN }, SL_GPIO_MODE_PUSH_PULL, 1);
